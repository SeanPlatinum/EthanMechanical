  ...
  return (
    <ul className="text-sm items-stretch self-stretch box-border caret-transparent hidden shrink-0 justify-center leading-[22.4px] list-none min-h-0 min-w-px outline-[3px] w-full pl-0 md:text-base md:flex md:leading-[25.6px] md:min-h-[auto]">
      {navItems.map((item) => (
        <li
          key={item.to}
          className="relative text-sm items-stretch box-border caret-transparent flex shrink-0 justify-center leading-[22.4px] min-h-0 min-w-px outline-[3px] md:text-base md:leading-[25.6px] md:min-h-[auto]"
        >
          <Link
            to={item.to}
